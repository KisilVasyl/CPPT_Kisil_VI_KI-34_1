...
/**
* Class <code>VideoCamera</code> implements camera
*/
public class VideoCamera extends Camera implements IRecord {
...
public VideoCamera (int photo) throws FileNotFoundException
{
	PhotoButton = new Button();
...
public void makeVideo()
{
	...
	{
	if (PhotoStorage.makeVid()==true)
	{
	System.out.print("You record a video"+"\n");
	fout.print("You record a video"+"\n");
	}
	}	
}
